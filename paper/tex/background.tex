...
\begin{figure}[tp!]
	...
	\end{subfigure}
	\\
	\caption{Multi-user autoencoder system architecture including a detailed view of the BaseRX's decoder network. At the receiver, signals are passed through the pre-decoder network first and then each transmitter's message is extracted separately using its corresponding decoder network.}	
