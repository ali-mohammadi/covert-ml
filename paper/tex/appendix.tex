...
\begin{appendices}
	...
	Table \ref{table:autoencoder_structure} illustrates the layers and output sizes of autoencoder DNN models in the single-user and multi-user systems. Table \ref{table:covert_models_structure} shows the DNN model structure of each covert actor in single and multi-user systems.
...
\begin{table*}[!th]
	\begin{adjustbox}{width=1\textwidth,center}
		...
		\end{tabular}
	\end{adjustbox}
	\caption{Autoencoder's detailed network architecture in single-user and multi-user systems.}
...
\begin{table}[!th]
	\begin{adjustbox}{width=1\textwidth,center}
		\begin{tabular}{c|c|c|c|c|c|}
			\cline{2-6}
			\multicolumn{1}{l|}{} & \textbf{Alice (Single-User)} & \textbf{Alice (Multi-User) AWGN} & \textbf{Alice (Multi-User) Rayleigh} & \textbf{Bob} & \textbf{Willie} \\ \hline
		...
		\end{tabular}
	\end{adjustbox}
	\caption{Alice, Bob, and Willie's detailed network architecture in single-user and multi-user systems.}
