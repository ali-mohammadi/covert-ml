...
\begin{appendices}
	...
	Table \ref{table:autoencoder_structure} presents the layer configuration and output sizes of the autoencoder DNN models used in the single-user and multi-user system. Table \ref{table:covert_models_structure} displays the DNN model structure of the covert actors and their differences in single-user and multi-user system.
\begin{table*}[!th]
	\begin{adjustbox}{width=1\textwidth,center}
		...
		\end{tabular}
	\end{adjustbox}
	\caption{Autoencoder's detailed network architecture in the single-user and multi-user system.}
...
\begin{table}[!th]
	\begin{adjustbox}{width=1\textwidth,center}
		...
		\end{tabular}
	\end{adjustbox}
	\caption{Alice, Bob, and Willie's detailed network architecture in the single-user and multi-user system.}
